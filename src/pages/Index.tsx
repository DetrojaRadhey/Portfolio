...
const Index = () => {
  ...
  const NavLink = ({ href, children, className }: {
    ...
    <button
      ...
      className={`relative px-3 py-2 text-sm font-medium transition-all duration-300 hover:text-purple-400 hover:scale-110 ${activeSection === href ? "text-purple-400" : "text-gray-300"
        } ${className}`}
    >
      {children}
      {activeSection === href && (
